...
@Component({
  selector: 'app-cancer-soporte',
  templateUrl: './cancer-soporte.component.html',
  styleUrls: ['./cancer-soporte.component.css']
})
export class CancerSoporteComponent implements OnInit {
